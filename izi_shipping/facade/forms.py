...
class BasePecomForm(forms.Form):
    ...
    transportingType = forms.IntegerField(
        widget=forms.HiddenInput, required=False)


class PecomCalcForm(BasePecomForm):
    options_template = "izi_shipping/partials/pecom_options.html"
    ...
    def __init__(self, *args, **kwargs):
        ...
        details_url = reverse_lazy(
            'shipping:charge-details', kwargs={'slug': 'pek'})
        ...
        if options:
            ...
            for o in options:
                ...
                opts.append((o['id'], render_to_string(
                    self.options_template, opt_ctx)))

            self.fields['transportingType'] = forms.ChoiceField(label=_("Type of transportation"),
                                                                help_text=_(
                                                                    "Please choose the transportation type"),
                                                                choices=opts,
...
class EmsCalcForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        options = None
        details_url = reverse_lazy(
            'shipping:charge-details', kwargs={'slug': 'ems'})
